...
import { ArrowRight, ExternalLink, Linkedin, Mail, Twitter, X } from "lucide-react";
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-0">
            <div className="relative">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/90 to-transparent">
                <div className="flex gap-3 text-white">
                  {teamMember.linkedin && (
                    <a href="#" className="p-2 bg-black/30 backdrop-blur-sm rounded-full hover:bg-orange-600 transition-colors">
                      <Linkedin size={18} />
                    </a>
                  )}
                  {teamMember.twitter && (
            ...
            <div className="p-8 md:p-10">
              ...
              <h3 className="text-3xl font-black tracking-tighter mb-2">{teamMember.name}</h3>
              <div className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-6">{teamMember.title}</div>
              ...
              {teamMember.achievements && (
                <div className="mt-8">
                  <div className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-3">Key Achievements</div>
              ...
              <div className="mt-10 pt-6 border-t border-slate-100">
                <a href="#" className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-widest hover:text-orange-600 transition-colors">
